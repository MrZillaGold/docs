...
[support]: https://discord.gg/DUBkqFUshQ
[language]: https://discord.com/developers/docs/dispatch/field-values#predefined-field-values-accepted-locales

This page covers the Terms of Service (Terms) and Privacy Policy of the Discord Bot **Steve**.
...
### Contact
People may get in contact through the official [Support Discord][support] of the Bot.  
...
Guilds:
- `id` with the Guild ID as value.
- `language` with value `en`.
- `created_at` with first invite timestamp.

Users:
- `id` with the User ID as value.
- `created_at` with first interaction timestamp.
